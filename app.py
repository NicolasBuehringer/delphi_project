...
from project_delphi.params import (
    link_current_poll, link_historic_polls, link_tweet_kpis, link_most_liked_tweets,
    link_most_retweeted_tweets, link_logo, link_predicition, link_no_of_tweets
)
...
st.markdown("\* Others are a combination of the current non-parliamentary parties")
st.markdown("")
st.markdown("")
